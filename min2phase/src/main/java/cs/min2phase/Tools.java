...
public class Tools {
     ...
     *
     * The random source can be set by {@link Tools#setRandomSource(Random)}
     *
     ...
     *
     * @see Tools#setRandomSource(Random)
     * @see Search#solution(String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @param facelets is the cube definition string , see {@link Search#solution(String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
